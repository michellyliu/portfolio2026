        ...
        <div className="max-w-[1600px] mx-auto px-[28px] md:px-[64px] lg:px-[120px]">
          ...
          >
            <div className="flex flex-col gap-[40px]">
              ...
              ></span> Currently at JPMorganChase and nurturing my creative garden.
      ...
      <section className="relative pt-[56px] pb-[56px] md:pt-[96px] md:pb-[96px] lg:pt-[104px] lg:pb-[104px] border-t-[0.5px] border-b-[0.5px] border-[#3B2B15] dark:border-[#FFFBF5]/80 dark:border-[#FFFBF5]/80">
        <div className="max-w-[1600px] mx-auto px-[28px] md:px-[64px] lg:px-[120px]">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-0 relative">
            ...
            <div className="hidden lg:block absolute left-1/3 top-0 bottom-0 w-[0.5px] bg-[#3B2B15]/80 -translate-x-1/2"></div>
            <div className="hidden lg:block absolute left-2/3 top-0 bottom-0 w-[0.5px] bg-[#3B2B15]/80 -translate-x-1/2"></div>
