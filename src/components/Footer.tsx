      ...
      <div className="max-w-[1600px] mx-auto px-[32px] md:px-[64px] lg:px-[120px]">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-0">
          <div className="flex items-center gap-3">
            <p className="text-[12px] md:text-[14px] font-sans font-normal text-[#3B2B15]/80 dark:text-[#FFFBF5] leading-normal transition-colors duration-300">
              Designed & Developed by Michelle Liu · 2026
            </p>
            {/* <motion.div
              animate={{
                y: [0, -2, 0],
          ...
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-6">
            <a
              ...
              className="flex items-center gap-2 text-[14px] md:text-[16px] font-sans font-normal text-[#3B2B15]/80 dark:text-[#FFFBF5] leading-[1.2] tracking-[-0.32px] md:tracking-[-0.36px] hover:scale-95 active:scale-90 transition-transform"
            >
